...
- canonical dump/export invariants, including richer edge value shapes, recursive type-tag preservation for ambiguous value kinds, and canonical edge property ordering
